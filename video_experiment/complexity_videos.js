...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var globalStyles = `
        <style>
            ...
            .jspsych-display-element {
                max-width: 95%; /* Reduced back to 95% to prevent horizontal scroll */
                width: 95vw;
                min-width: 800px; /* Reduced to prevent horizontal scroll */
                max-height: 90vh; /* Increased from 95vh to give more vertical space */
                background: white;
                padding: 25px 40px; /* Reduced horizontal padding */
                border-radius: 12px;
                box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.2);
                margin: 1vh auto; /* Reduced margin to use more screen space */
                overflow-y: auto; /* Allow scrolling if needed */
                overflow-x: hidden; /* Prevent horizontal scrolling */
                position: relative;
                top: 0px; /* Removed negative top positioning */
            }
            ...
            .jspsych-slider-response-labels {
                ...
                margin: 15px auto 10px auto; /* Increased top margin */
                font-size: 16px;
                color: #555;
            ...
            .jspsych-slider-response-labels span {
                flex: 1;
                text-align: center;
                padding: 0 5px;
            }

            /* Crop videos in video slider response trials */
            .jspsych-video-slider-response video,
            .jspsych-video-slider-response-stimulus video,
            .jspsych-content video {
            ...
            @media (max-height: 600px) {
                ...
                .video-slider-trial .jspsych-content {
                    padding: 10px;
                }
    ...
    const chosenarray = chosenarray0.slice(0, 20);
    ...
    var trial1 = {
        ...
        pages: [
            '<div style="text-align: center; margin-bottom: 10px;"><img src="stanford.png"></div>' +
    ...
    var practice_image_data = [
        { stimulus: "pictures/concave.png", correct_above: 50 },
        { stimulus: "pictures/circle.png", correct_below: 50 },
        { stimulus: "pictures/polygon.png", correct_below: 50 },
        { stimulus: "pictures/random.png", correct_below: 50 }
    ];
                ...
                stimulus: function () {
                    ...
                    return `
                        <div style="position: relative; text-align: center; padding: 20px;">
                            <img src="pictures/${stimulus}" style="height: 200px; margin-bottom: 10px;">
        ...
        timeline: [
            {
                ...
                <div style="margin-top: -10px;">
                    <p style="font-size:22px;">How complex is this object?</p>
                </div>
            `,
                //stimulus_height: 100,
                require_movement: true,
