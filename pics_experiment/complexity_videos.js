        ...
        timeline: [
            {
                ...
                stimulus_css: {
                    "width": "100px",
                    "height": "auto",
                    "margin-top": "0px", // Changed from -10px to positive value
                    "margin-bottom": "15px"
                },
                slider_container_css: {
                    "margin-top": "0px", // Changed from -30px to positive value
                    "position": "relative",
                    "width": "400px",
                    "margin": "0 auto"
                },
                button_css: {
                    "margin-top": "10px" // Changed from -30px to positive value
                },
                require_movement: true,
